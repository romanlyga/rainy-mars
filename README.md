...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/6049efc8c6e7ba00155a5ff9
...
To start editing your site, you can use the Sanity interface at https://rainy-mars-9efc8.sanity.studio/.
...
Generated at `2021-03-11T10:25:37.321Z` by Stackbit version `0.3.50`.